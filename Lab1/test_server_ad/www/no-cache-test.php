...
[缓存] 成功发送缓存数据到客户端</pre>
        ...
        <div class="btn-container">
            ...
            <a href="cache-test.php" class="refresh-btn" style="background: #ff9800; display: inline-block;">测试固定时间页面</a>
